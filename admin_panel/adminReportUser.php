...
if (isset($_SESSION["admin"])) {
    ...
    `users`.`position_id` = `user_type`.`id`  WHERE `position_id`='1' ORDER BY `users`.`joined_date` ASC ");
...
?>
    ...
    <meta charset="UTF-8">
        ...
        <title>Amazon.lk | User Report</title>
        <style>
            .anker{
                color: black;
    ...
    <?php include "adminNavBar.php"; ?>
        ...
        <div class="container" id="printArea">
            <h2 class="text-center">User Report and Managemant</h2>
            <hr>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                if ($d["status_id"] == 1) {
                                    ?>
                                    <a class="btn btn-warning" onclick='deactive(<?php echo $d["email"]; ?>);'>Active</a>
                                    <?php
                                } else {
                                    ?>
                                    <a class="btn btn-danger" onclick='active(<?php echo $d["email"]; ?>);'>Deactive</a>
                                    <?php
                                }
                                ?>
                            </td>
